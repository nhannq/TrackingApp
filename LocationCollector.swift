...
//            var newLocation = realLocations[i]
            ...
            if theAccuracy > 0.0 && theAccuracy < 2000.0 &&
        ...
        self.shareModel!.timer = NSTimer.scheduledTimerWithTimeInterval(30, target: self, selector: Selector("restartLocationUpdates"), userInfo: nil, repeats: false)
